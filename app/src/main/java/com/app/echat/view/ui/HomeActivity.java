...
import com.app.echat.view.adapters.ViewPagerAdapter;
import com.app.echat.view.fragments.ChatFragment;
import com.app.echat.view.fragments.ProfileFragment;
import com.app.echat.view.fragments.UserFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        logInViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) ViewModelProvider.AndroidViewModelFactory
                .getInstance(getApplication()))
                .get(LogInViewModel.class);

        toolbar = findViewById(R.id.toolbar);

        databaseViewModel = new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) ViewModelProvider.AndroidViewModelFactory
                .getInstance(getApplication()))
