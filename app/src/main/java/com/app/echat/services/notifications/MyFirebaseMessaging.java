package com.app.echat.services.notifications;
...
import com.app.echat.view.ui.MessageActivity;
...
public class MyFirebaseMessaging extends FirebaseMessagingService implements LifecycleOwner {
    ...
    LogInViewModel logInViewModel = getInstance(getApplication()).create(LogInViewModel.class);
